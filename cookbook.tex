...
\begin{center}
  \vspace*{\fill}
  \textsc{\Huge \maintitle\\[2ex] \huge \subtitle}
  \vfill
  \footnotesize{
  Copyright \copyright{} 
...
\thispagestyle{empty}
\begin{multicols*}{3}
  {\footnotesize \disclaimer}
  \tableofcontents
\end{multicols*}

\newpage

\section{\DistributionOverview}

\subsection{\DiscreteDistributions}
...
\footnotetext{\FootnoteNotation}

\pagebreak

\subsection{\ContinuousDistributions}
...
\begin{tabular}{@{}l*6{>{\begin{math}\displaystyle}c<{\end{math}}}@{}}
  ...
  \InverseGamma & \invgamma & \pinvgamma & \dinvgamma &
...
\Definitions
\begin{itemize}
  \item \SampleSpace\ $\Omega$
  \item \Outcome\ $\omega \in \Omega$
  \item \Event\ $A \subseteq \Omega$
  \item \SigmaAlgebra\ $\mathcal{A}$
    \begin{enumerate}
    ...
    \end{enumerate}
  \item \ProbabilityDistribution\ $\prob$
    \begin{enumerate}
    ...
    \end{enumerate}
  \item \ProbabilitySpace\ $(\Omega,\mathcal{A},\prob)$
\end{itemize}
